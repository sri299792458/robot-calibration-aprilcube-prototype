...
DEFAULT_TARGET_CONFIG = (
    WORKSPACE_ROOT / "aprilcube" / "models" / "dex3_safe_cube" / "config.json"
)
DEFAULT_QUALITY_CONFIG = WORKSPACE_ROOT / "config" / "capture_quality.yaml"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    preview.add_argument(
        ...
        help="AprilCube config.json (default: exact printed dex3_safe_cube)",
    )
    preview.add_argument(
        "--quality-config",
        type=Path,
