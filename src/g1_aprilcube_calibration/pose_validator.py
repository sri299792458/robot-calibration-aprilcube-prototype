    ...
    def validate(
        ...
        *,
        ...
        calibration_q_by_id = {
            ...
            **{
                pose.id: np.asarray(pose.command_calibration_q)
        ...
        for edge_index, (source_id, target_id) in enumerate(edge_keys):
            ...
            if progress is not None:
                progress(edge_index + 1, edge_count, source_id, target_id)
